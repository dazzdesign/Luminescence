        ...
        <div className="footer-logo">
          ...
          <div className="footer-social">
            ...
            <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
              <svg viewBox="0 0 24 24">
                <path d="M6.94 6.02a1.44 1.44 0 110-2.88 1.44 1.44 0 010 2.88zM4.5 8.25H9v11.25H4.5V8.25zM10.88 8.25h4.31v1.65h.06c.6-1.14 2.06-2.34 4.23-2.34 4.52 0 5.36 2.97 5.36 6.83v7.11h-4.5v-6.3c0-1.5-.03-3.43-2.1-3.43-2.1 0-2.42 1.63-2.42 3.31v6.42H10.88V8.25z" />
              </svg>
            </a>
          </div>
        </div>
